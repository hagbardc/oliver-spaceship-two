...
audio_config = [
            ...
            {'name': 'light_amp_moderate',      'sound': 'audio_files/light_amp_moderate.wav', 'loopable': False},
            {'name': 'light_amp_maximum',       'sound': 'audio_files/light_amp_maximum.wav', 'loopable': False},
            {'name': 'light_amp_nominal',       'sound': 'audio_files/light_amp_nominal.wav', 'loopable': False},
            ...
            {'name': 'arm_retracted',           'sound': 'audio_files/arm_retracted.wav', 'loopable': False},
            {'name': 'arm_extended',            'sound': 'audio_files/arm_extended.wav', 'loopable': False},
            {'name': 'data_transfer_initiated', 'sound': 'audio_files/data_transfer_initiated.wav', 'loopable': False},
            {'name': 'data_transfer_complete',  'sound': 'audio_files/data_transfer_complete.wav', 'loopable': False},
            ...
            {'name': 'camera_engaged',          'sound': 'audio_files/camera_engaged.wav', 'loopable': False},
            {'name': 'camera_offline',          'sound': 'audio_files/camera_offline.wav', 'loopable': False},
            ...
            {'name': 'ecm_online',              'sound': 'audio_files/ecm_online.wav', 'loopable': False},
            {'name': 'ecm_offline',             'sound': 'audio_files/ecm_offline.wav', 'loopable': False},
            {'name': 'beagle_engaged',          'sound': 'audio_files/beagle_engaged.wav', 'loopable': False},
            {'name': 'beagle_shutdown',         'sound': 'audio_files/beagle_shutdown.wav', 'loopable': False},
            {'name': 'c3_online',               'sound': 'audio_files/c3_online.wav', 'loopable': False},
            {'name': 'c3_shutdown',             'sound': 'audio_files/c3_shutdown.wav', 'loopable': False},
            ...
            {'name': 'lbx_10',                  'sound': 'audio_files/lbx_10.wav', 'loopable': False},
            {'name': 'srm4_launch',             'sound': 'audio_files/srm4_launch.wav', 'loopable': False},
            {'name': 'xpulse_large',            'sound': 'audio_files/xpulse_large.wav', 'loopable': False},
            {'name': 'laser_small',             'sound': 'audio_files/laser_small.wav', 'loopable': False},
            {'name': 'laser_large',             'sound': 'audio_files/laser_large.wav', 'loopable': False},
